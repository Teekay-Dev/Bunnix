...
function Section({ title, Icon, children, danger }) {
  return (
    <div
      className={`bg-white dark:bg-[#111] rounded-2xl p-6 mb-4 shadow-sm border ${danger ? "border-red-200 dark:border-red-900/40" : "border-gray-200 dark:border-white/8"}`}
    >
      <div
        className={`flex items-center gap-2.5 mb-5 pb-4 border-b ${danger ? "border-red-100 dark:border-red-900/30" : "border-gray-100 dark:border-white/8"}`}
      >
        <div
          className={`w-8 h-8 rounded-lg flex items-center justify-center ${danger ? "bg-red-50 dark:bg-red-900/20" : "bg-orange-50 dark:bg-orange-500/10"}`}
        >
          <Icon
            size={15}
        ...
        <span
          className={`font-bold text-sm ${danger ? "text-red-600 dark:text-red-400" : "text-gray-900 dark:text-gray-100"}`}
        >
          {title}
        </span>
      </div>
    ...
    <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <div className="relative shrink-0">
            <div
              style={{
                ...
                boxShadow: "0 0 0 4px rgba(232,93,4,.15)",
                background: photo
                  ? "transparent"
                  : "linear-gradient(135deg,#E85D04,#c94e03)",
                display: "flex",
                alignItems: "center",
      ...
      <Section title="Change Password" Icon={Lock}>
        ...
        <button
          ...
          disabled={!curPw || !newPw || newPw !== confPw}
