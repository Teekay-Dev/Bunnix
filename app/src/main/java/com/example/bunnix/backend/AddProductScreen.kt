...
@Composable
fun AddProductScreen(viewModel: ProductViewModel, onViewProducts: () -> Unit) {
    var image_url by remember { mutableStateOf<Uri?>(null) }
        ...
        Column(
            ...
            Box(
                ...
                if (image_url != null) {
                    ...
                    Text("Tap to add image", color = Color.LightGray, fontSize = 14.sp)
                }
            }
